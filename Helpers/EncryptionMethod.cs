...
namespace BlazorApp.Helpers  
    {  
        ...
        {  
            public static string keyPublic="b14ca5898a4e4133bbce2ea2315a1916";
            public static async Task<string> Encrypt(string plainText)
            {
                string data= await EncryptString( keyPublic,  plainText);
                return data;
            }

            public static async Task<string> Decrypt(string plainText)
            {
                string data= await DecryptString( keyPublic,  plainText);
                return data;
            }
